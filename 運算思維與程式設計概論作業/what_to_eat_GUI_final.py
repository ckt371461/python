...
class SampleApp(tk.Tk):
    def __init__(self):
        tk.Tk.__init__(self)
        self.bg_image = PhotoImage(file="北醫.png")
...
class StartPage(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        tk.Label(self, text="午餐吃甚麼",font=("微軟正黑體", 20)).pack(side="top", fill="x", pady=10)
        tk.Button(self, text="開始",bg="yellow",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: master.switch_frame(budgete)).pack()
        tk.Button(self, text="隨機",bg="light gray",fg="black",font=("微軟正黑體", 16),
                  command=lambda: master.switch_frame(randomchoose)).pack()
        tk.Button(self, text="新增餐廳",bg="light gray",fg="black",font=("微軟正黑體", 16),
                  command=lambda: master.switch_frame(new_1)).pack()
...
class budgete(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        tk.Label(self, text="預算:",font=("微軟正黑體", 20)).pack(pady=5)
        price_entry = tk.Entry(self,font=("微軟正黑體", 16))
        price_entry.pack(pady=5)
        tk.Button(self, text="下一步",bg="light gray",fg="black",font=("微軟正黑體", 16),
                  command=lambda: (button_clicked(), master.switch_frame(type))).pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16),
...
class type(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        tk.Label(self, text="請選擇食物種類:",font=("微軟正黑體", 20)).pack(pady=5)
        tk.listbox = tk.Listbox(self,font=("微軟正黑體", 16), selectmode=tk.MULTIPLE)  
        tk.listbox.pack(pady=10)
        items = ["飯類", "麵類", "堡類", "餃類"]
        for item in items:
            tk.listbox.insert(tk.END, item)
        tk.Button(self, text="下一步",bg="light gray",fg="black",font=("微軟正黑體", 16),
                  command=lambda: (button_clicked(), master.switch_frame(like))).pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16),
                  command=lambda: master.switch_frame(StartPage)).pack()
...
class like(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        tk.Label(self, text="請選擇偏好:",font=("微軟正黑體", 20)).pack(pady=5)
        tk.listbox = tk.Listbox(self,font=("微軟正黑體", 16), selectmode=tk.MULTIPLE)
        tk.listbox.pack(pady=10)
        items = ["辣", "香菜"]
        for item in items:
            tk.listbox.insert(tk.END, item)
        tk.Button(self, text="下一步",bg="light gray",fg="black",font=("微軟正黑體", 16),
                  command=lambda: (button_clicked(), master.switch_frame(dislike))).pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: master.switch_frame(StartPage)).pack()
...
class dislike(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        tk.Label(self, text="請選擇忌口:",font=("微軟正黑體", 20)).pack(pady=5)
        tk.listbox = tk.Listbox(self,font=("微軟正黑體", 16), selectmode=tk.MULTIPLE)
        tk.listbox.pack(pady=10)
        items = ["辣", "香菜"]
        for item in items:
            tk.listbox.insert(tk.END, item)
        tk.Button(self, text="看結果",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: (button_clicked(), master.switch_frame(choose))).pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: master.switch_frame(StartPage)).pack()
...
class choose(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        self.shared_data = shared_data
        master.title("午餐吃甚麼")
        self.text_widget = scrolledtext.ScrolledText(self,font=("微軟正黑體", 16), wrap=tk.WORD)
        ...
        tk.Button(self, text="隨機選擇",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: (button_clicked(),master.switch_frame(rd))).pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: master.switch_frame(StartPage)).pack()
        def button_clicked():
...
class rd(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        tk.Button(self, text="再次隨機",bg="light gray",fg="black",font=("微軟正黑體", 16), 
...
class new_1(tk.Frame):
    def __init__(self, master, shared_data):
        tk.Frame.__init__(self, master)
        self.shared_data = shared_data
        newrestaurant = tk.Label(self, text="名稱",font=("微軟正黑體", 20))
        newrestaurant.pack(pady=5)
        self.restaurantname = tk.Entry(self,font=("微軟正黑體", 16))
        self.restaurantname.pack(pady=5)

        type_label = tk.Label(self, text="類別",font=("微軟正黑體", 20))
        type_label.pack(pady=5)

        self.listbox_type = tk.Listbox(self,font=("微軟正黑體", 16), selectmode=tk.MULTIPLE)
        ...
        button = tk.Button(self, text="下一步",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                           command=lambda: (button_clicked(), master.switch_frame(new_2)))
        button.pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: master.switch_frame(StartPage)).pack()
...
class new_2(tk.Frame):
    def __init__(self, master, shared_data):
        ...
        label_low = tk.Label(self, text="價格下限:",font=("微軟正黑體", 20))
        label_low.pack(pady=5)
        price_low = tk.Entry(self,font=("微軟正黑體", 16))
        price_low.pack(pady=5)

        label_high = tk.Label(self, text="價格上限:",font=("微軟正黑體", 20))
        label_high.pack(pady=5)
        price_high = tk.Entry(self,font=("微軟正黑體", 16))
        price_high.pack(pady=5)

        specialty_label = tk.Label(self, text="特性",font=("微軟正黑體", 20))
        specialty_label.pack(pady=5)

        listbox_specialty = tk.Listbox(self,font=("微軟正黑體", 16), selectmode=tk.MULTIPLE)
        ...
        button = tk.Button(self, text="完成",bg="light gray",fg="black",font=("微軟正黑體", 16),
                           command=lambda: (button_clicked(), master.switch_frame(complete)))
        button.pack()
        tk.Button(self, text="回選單",bg="light gray",fg="black",font=("微軟正黑體", 16), 
                  command=lambda: master.switch_frame(StartPage)).pack()
...
class complete(tk.Frame):
    def __init__(self, master,shared_data):
         tk.Frame.__init__(self, master)
         tk.label = tk.Label(self, text="新增完成",font=("微軟正黑體", 16))
         tk.label.pack(pady=5)
         tk.Button(self,bg="light gray",fg="black",font=("微軟正黑體", 16), text="回選單", command=lambda: master.switch_frame(StartPage)).pack()
